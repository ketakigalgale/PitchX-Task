  ...
  return (
    <div className="w-80 min-h-screen  bg-gradient-to-br from-gray-900/40 bg-black text-white p-10 space-y-6 rounded-tr-4xl border-r border-gray-100">
      ...
      <section>
        ...
        <p className="mt-1 text-sm text-gray-500">Posts : 6 | Likes : 120 </p>
      </section>

     
      <section>
        <h2 className="text-lg font-semibold text-purple-400 mb-2">🏆 Leaderboard</h2>
        <ol className="space-y-1 text-sm text-gray-300">
          ...
          <li>3. <span className="text-purple-400 font-medium">You</span> - 376 pts</li>
      ...
      <section>
        <h2 className="text-lg font-semibold text-purple-400 mb-2">🧩 Top Projects</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-purple-400 mb-2">💡 Top Skills</h2>
